    ...
    return BlocConsumer<TripsCubit,TripsState>(
      ...
      builder: (context,state){
        return Scaffold(
          ...
          state is GetAllTripsLoading || state is GetProfitsTripsLoading    ?  const Center(child: CircularProgressIndicator()) :
                                        ...
                                        var items = [
                                          {
                                            ...
                                            "price": " Company Trips        ${TripsCubit.get(context).getTripsProfitModel!.data!.companyCount} ",
                                          },
                                          {
                                            "image": "assets/images/home/accom.png",


                                            "price": " Individual Trips         ${TripsCubit.get(context).getTripsProfitModel!.data!.individualCount}  ",
                                          },
                                        ];
