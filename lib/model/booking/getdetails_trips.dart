class GetBookingDetailsTripsModel {
  int? statusCode;
  String? message;
  Data? data;

  GetBookingDetailsTripsModel({this.statusCode, this.message, this.data});

  GetBookingDetailsTripsModel.fromJson(Map<String, dynamic> json) {
